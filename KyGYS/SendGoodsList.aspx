...
<body>
    <form runat="server">
        ...
        <table title="" id="tt" rownumbers="true" pagination="true" style="width: 100%; height: 309px"
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'LogisNo',width:150,sortable:true">物流单号</th>
                    <th data-options="field:'LogisName',width:150,sortable:true">物流公司</th>
                    <th data-options="field:'LogisCost',width:150,sortable:true">实际运费</th>
                    <th data-options="field:'LogisMobile',width:150,sortable:true">物流电话</th>
                </tr>
            </thead>
        </table>
        ...
        <table title=""  id="orderlist" rownumbers="true" style="width: 100%; height: 150px"
...
<%--                    <th data-options="field:'ItemName',width:200,sortable:true" title="admin">商品名称</th>
                    ...
                    <th data-options="field:'BatchItemCount',width:60,sortable:true">数量</th>
    ...
    <script type="text/javascript">
        $(function () {
                ...
                $.messager.confirm("系统提示", "是否修改？", function (data) {
                    if (!data) {
                        ...
                        $.ajax({
                            ...
                            error: function () {
                                msgShow('系统提示', '操作失败请联系客易技术！', 'error');
                            },
            ...
            //       { field: 'Reserved2', title: '收货地址', width: '200', sortable: true },
            //       { field: 'LogisNo', title: '物流单号', width: '150', sortable: true },
            //       { field: 'LogisName', title: '物流公司', width: '150', sortable: true },
            //      { field: 'LogisCost', title: '实际运费', width: '150', sortable: true },
            //      { field: 'LogisMobile', title: '物流电话', width: '150', sortable: true }
            //    ]],
            //});
            $('#tt').datagrid({
        ...
        function SelectRow(rowIndex, rowData) {
            ...
            $('#orderlist').datagrid({
                ...
                columns: [[
               { field: 'ItemName', title: '商品名称', width: '200', sortable: true },
               { field: 'SkuProperties', title: '规格名称', width: '190', sortable: true },
               { field: 'OuterIid', title: '商品编码', width: '200', sortable: true, align: 'left' },
               { field: 'OuterSkuId', title: '规格编码', width: '200', sortable: true, align: 'left' },
               { field: 'Num', title: '数量', width: '40', sortable: true },
               { field: 'PackageCount', title: '包件数', width: '40', sortable: true },
               { field: 'BusVolume', title: '体积', width: '80', sortable: true, align: 'left' },
               { field: 'Size', title: '尺寸', width: '80', sortable: true, align: 'left' },
               { field: 'Color', title: '颜色', width: '110', sortable: true, align: 'left' },
               { field: 'Remark', title: '备注', width: '110', sortable: true, align: 'left' }
                ]],
            });
            $('#orderlist').datagrid({
                onLoadSuccess: function (data) {
